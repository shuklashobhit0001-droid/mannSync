...
export declare class Voices {
     ...
     *     })
     */
    get(voice_id: string, request?: ElevenLabs.VoicesGetRequest, requestOptions?: Voices.RequestOptions): core.HttpResponsePromise<ElevenLabs.Voice>;
    private __get;
    /**
     ...
     */
    delete(voice_id: string, requestOptions?: Voices.RequestOptions): core.HttpResponsePromise<ElevenLabs.DeleteVoiceResponseModel>;
    private __delete;
    /**
     ...
     *     })
     */
    update(voice_id: string, request: ElevenLabs.BodyEditVoiceV1VoicesVoiceIdEditPost, requestOptions?: Voices.RequestOptions): core.HttpResponsePromise<ElevenLabs.EditVoiceResponseModel>;
    private __update;
    /**
     ...
     *     })
     */
    share(public_user_id: string, voice_id: string, request: ElevenLabs.BodyAddSharedVoiceV1VoicesAddPublicUserIdVoiceIdPost, requestOptions?: Voices.RequestOptions): core.HttpResponsePromise<ElevenLabs.AddVoiceResponseModel>;
    private __share;
    /**
