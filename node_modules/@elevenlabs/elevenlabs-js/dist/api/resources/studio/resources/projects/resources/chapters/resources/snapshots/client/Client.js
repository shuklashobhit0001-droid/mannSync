...
class Snapshots {
     ...
     */
    get(project_id, chapter_id, chapter_snapshot_id, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__get(project_id, chapter_id, chapter_snapshot_id, requestOptions));
    }
    __get(project_id, chapter_id, chapter_snapshot_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
            const _headers = (0, headers_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_1.mergeOnlyDefinedHeaders)({ "xi-api-key": (_b = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.apiKey) !== null && _b !== void 0 ? _b : (_c = this._options) === null || _c === void 0 ? void 0 : _c.apiKey }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.ElevenLabsEnvironment.Production, `v1/studio/projects/${core.url.encodePathParam(project_id)}/chapters/${core.url.encodePathParam(chapter_id)}/snapshots/${core.url.encodePathParam(chapter_snapshot_id)}`),
                method: "GET",
                headers: _headers,
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
                timeoutMs: ((_j = (_g = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _g !== void 0 ? _g : (_h = this._options) === null || _h === void 0 ? void 0 : _h.timeoutInSeconds) !== null && _j !== void 0 ? _j : 240) * 1000,
     ...
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     */
    stream(project_id, chapter_id, chapter_snapshot_id, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__stream(project_id, chapter_id, chapter_snapshot_id, request, requestOptions));
    }
    __stream(project_id_1, chapter_id_1, chapter_snapshot_id_1) {
        return __awaiter(this, arguments, void 0, function* (project_id, chapter_id, chapter_snapshot_id, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
            const _headers = (0, headers_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_1.mergeOnlyDefinedHeaders)({ "xi-api-key": (_b = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.apiKey) !== null && _b !== void 0 ? _b : (_c = this._options) === null || _c === void 0 ? void 0 : _c.apiKey }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.ElevenLabsEnvironment.Production, `v1/studio/projects/${core.url.encodePathParam(project_id)}/chapters/${core.url.encodePathParam(chapter_id)}/snapshots/${core.url.encodePathParam(chapter_snapshot_id)}/stream`),
                method: "POST",
                headers: _headers,
