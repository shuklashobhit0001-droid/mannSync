...
class Dubbing {
    ...
    get resource() {
        var _a;
        return ((_a = this._resource) !== null && _a !== void 0 ? _a : (this._resource = new Client_2.Resource(this._options)));
    }
    get audio() {
        var _a;
