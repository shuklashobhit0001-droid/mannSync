...
export declare class TextToVoice {
     ...
     *     })
     */
    remix(voice_id: string, request: ElevenLabs.VoiceRemixRequestModel, requestOptions?: TextToVoice.RequestOptions): core.HttpResponsePromise<ElevenLabs.VoiceDesignPreviewResponse>;
    private __remix;
}
