...
export declare class PronunciationDictionaries {
     ...
     *     })
     */
    create(project_id: string, request: ElevenLabs.studio.projects.BodyCreatePronunciationDictionariesV1StudioProjectsProjectIdPronunciationDictionariesPost, requestOptions?: PronunciationDictionaries.RequestOptions): core.HttpResponsePromise<ElevenLabs.CreatePronunciationDictionaryResponseModel>;
    private __create;
}
