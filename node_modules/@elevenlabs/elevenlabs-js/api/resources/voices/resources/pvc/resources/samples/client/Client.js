...
class Samples {
    ...
    __create(voice_id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.ElevenLabsEnvironment.Production, `v1/voices/pvc/${core.url.encodePathParam(voice_id)}/samples`),
                method: "POST",
                headers: _headers,
     ...
     */
    update(voice_id, sample_id, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__update(voice_id, sample_id, request, requestOptions));
    }
    __update(voice_id_1, sample_id_1) {
        return __awaiter(this, arguments, void 0, function* (voice_id, sample_id, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
