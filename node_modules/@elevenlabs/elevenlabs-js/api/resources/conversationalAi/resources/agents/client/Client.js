...
const Client_4 = require("../resources/widget/client/Client");
class Agents {
    ...
    get widget() {
        var _a;
        return ((_a = this._widget) !== null && _a !== void 0 ? _a : (this._widget = new Client_4.Widget(this._options)));
    }
    get link() {
        var _a;
    ...
    get knowledgeBase() {
        var _a;
        return ((_a = this._knowledgeBase) !== null && _a !== void 0 ? _a : (this._knowledgeBase = new Client_1.KnowledgeBase(this._options)));
    }
    get llmUsage() {
        var _a;
        return ((_a = this._llmUsage) !== null && _a !== void 0 ? _a : (this._llmUsage = new Client_3.LlmUsage(this._options)));
    }
    /**
