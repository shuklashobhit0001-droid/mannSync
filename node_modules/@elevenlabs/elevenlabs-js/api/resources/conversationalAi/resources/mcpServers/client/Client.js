...
class McpServers {
    ...
    get tools() {
        var _a;
        return ((_a = this._tools) !== null && _a !== void 0 ? _a : (this._tools = new Client_4.Tools(this._options)));
    }
    get approvalPolicy() {
        var _a;
        return ((_a = this._approvalPolicy) !== null && _a !== void 0 ? _a : (this._approvalPolicy = new Client_1.ApprovalPolicy(this._options)));
    }
    get toolApprovals() {
        var _a;
        return ((_a = this._toolApprovals) !== null && _a !== void 0 ? _a : (this._toolApprovals = new Client_2.ToolApprovals(this._options)));
    }
    get toolConfigs() {
        var _a;
        return ((_a = this._toolConfigs) !== null && _a !== void 0 ? _a : (this._toolConfigs = new Client_3.ToolConfigs(this._options)));
    }
    /**
    ...
    __get(mcp_server_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ElevenLabsTimeoutError("Timeout exceeded when calling GET /v1/convai/mcp-servers/{mcp_server_id}.");
                case "unknown":
                    throw new errors.ElevenLabsError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
