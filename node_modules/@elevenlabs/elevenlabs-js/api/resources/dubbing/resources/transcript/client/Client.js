...
class Transcript {
     ...
     *     })
     */
    getTranscriptForDub(dubbing_id, language_code, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__getTranscriptForDub(dubbing_id, language_code, request, requestOptions));
    }
    __getTranscriptForDub(dubbing_id_1, language_code_1) {
        return __awaiter(this, arguments, void 0, function* (dubbing_id, language_code, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
            const { formatType } = request;
            const _queryParams = {};
            if (formatType != null) {
                _queryParams.format_type = serializers.dubbing.TranscriptGetTranscriptForDubRequestFormatType.jsonOrThrow(formatType, { unrecognizedObjectKeys: "strip" });
            }
