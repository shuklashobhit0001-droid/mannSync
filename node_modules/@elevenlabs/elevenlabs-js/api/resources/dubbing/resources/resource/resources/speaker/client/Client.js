...
class Speaker {
     ...
     */
    update(dubbing_id, speaker_id, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__update(dubbing_id, speaker_id, request, requestOptions));
    }
    __update(dubbing_id_1, speaker_id_1) {
        return __awaiter(this, arguments, void 0, function* (dubbing_id, speaker_id, request = {}, requestOptions) {
     ...
     */
    findSimilarVoices(dubbing_id, speaker_id, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__findSimilarVoices(dubbing_id, speaker_id, requestOptions));
    }
    __findSimilarVoices(dubbing_id, speaker_id, requestOptions) {
