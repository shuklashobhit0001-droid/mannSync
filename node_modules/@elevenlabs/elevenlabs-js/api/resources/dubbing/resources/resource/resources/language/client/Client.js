...
class Language {
     ...
     */
    add(dubbing_id, request = {}, requestOptions) {
    ...
    __add(dubbing_id_1) {
        return __awaiter(this, arguments, void 0, function* (dubbing_id, request = {}, requestOptions) {
            ...
            const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.ElevenLabsEnvironment.Production, `v1/dubbing/resource/${core.url.encodePathParam(dubbing_id)}/language`),
                method: "POST",
                headers: _headers,
