...
class Segment {
     ...
     */
    update(dubbing_id, segment_id, language, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__update(dubbing_id, segment_id, language, request, requestOptions));
    }
    __update(dubbing_id_1, segment_id_1, language_1) {
        return __awaiter(this, arguments, void 0, function* (dubbing_id, segment_id, language, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
            const _headers = (0, headers_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_1.mergeOnlyDefinedHeaders)({ "xi-api-key": (_b = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.apiKey) !== null && _b !== void 0 ? _b : (_c = this._options) === null || _c === void 0 ? void 0 : _c.apiKey }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.ElevenLabsEnvironment.Production, `v1/dubbing/resource/${core.url.encodePathParam(dubbing_id)}/segment/${core.url.encodePathParam(segment_id)}/${core.url.encodePathParam(language)}`),
                method: "PATCH",
                headers: _headers,
